...
export const uz = {
  ...
  bot: {
    ...
    manageGuest: '📇 Shaxsiy havola',
    guestAsk: [
      '📇 *Shaxsiy taklif havolasi*',
      '',
      'Mehmon ismini yozing — har biri uchun alohida havola olasiz.',
      'Mehmon ochsa, sahifada “Hurmatli <ism>” deb chiqadi.',
      '',
      'Tugatgach “✅ Tayyor” bosing.',
    ].join('\n'),
    guestLink: (name: string, url: string): string => `👤 *${name}* uchun:\n${url}`,
  ...
  web: {
    ...
    guestGreeting: (name: string): string => `Hurmatli ${name}! 🌸`,
  },
};
